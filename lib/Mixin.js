...
Mixin = {
    ...
    getInitialState: function () {
        return {
            _formsyExValue: this.props.value ? this.props.value : '',
            _formsyExErrorMsgs: []
        };
    },
    ...
    validate: function (value) {
        var _value = value !== undefined ? value : this.state._formsyExValue,
    ...
    getValue: function () {
        return this.state._formsyExValue;
    },
